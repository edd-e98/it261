...
<head>
    ...
    <title>Currency 2 PHP form w/ dropdown [select and option]</title>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $_POST['currency'], )) {
            ...
            echo ('
                <div class="box">
                    <h2>Hello, '.$name.'.</h2>
                    <p>You now have <b>$'.floor($dollars).' American dollars</b>, and we will be e-mailing you at <b>'.$email.'</b> with your information, as well as depositing your funds at <b>'.$bank.'bank</b>.</p>
                </div>
            ');
        }
    } // End server request
